...
//    if (!args_.isEmpty()) {
//        if ((parseInt(args_[0]) == 1 && args_.size >= 8) || ((parseInt(args_[0]) == 3 || parseInt(args_[0]) == 6) && args_.size == 7)
//            || ((parseInt(args_[0]) == 2 || parseInt(args_[0]) == 4 || parseInt(args_[0]) == 5) && args_.size == 6)) {
